package com.grouptwo.registrapp_security_backend.exceptions.advice;
...
public class ProyectExceptionHandler {
    ...
    @ExceptionHandler (value = RgAppException.class)
    protected ResponseEntity<Object> handleException(RgAppException ex, WebRequest request) {
